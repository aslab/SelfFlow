...
bool self_flow__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("self_flow.msg._task.Task", full_classname_dest, 24) == 0);
  }
  self_flow__msg__Task * ros_message = _ros_message;
  {  // id
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * self_flow__msg__task__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Task */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("self_flow.msg._task");
  ...
  self_flow__msg__Task * ros_message = (self_flow__msg__Task *)raw_ros_message;
  {  // id
    PyObject * field = NULL;
